...
from holdingArea import holdingArea
...
if demo:
    ...
    while (True):
		...
		handInImage = detection.detectHand(currentSum, startSum)
		...
		# Start moving pins.
		if (start):
			blurImg, tH, h, s, v = helperMethods.prepareImage(frame)
			pinsCandidates, collectionArea = detection.findCircles(blurImg, tH)
